...
import { getOffersPage, getTechnologyCloud } from '@/lib/jobs';
...
export default async function OffersPage({ searchParams }: OffersPageProps) {
  ...
  const [liste, cloud] = await Promise.all([getListeContent(), getTechnologyCloud()]);
    ...
    <div className={styles.page}>
      ...
      <main className={styles.container}>
        <section className={styles.panel}>
          ...
          <TagCloud tags={cloud.slice(0, 6)} />
          <div className={styles.topBar}>
            <p className={styles.countText}>📁 {paged.total} offres</p>
